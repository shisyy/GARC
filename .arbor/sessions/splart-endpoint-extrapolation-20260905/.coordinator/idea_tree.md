...
**Insight**: Target-free export now covers 10/12 fresh scratch checkpoints. All ten profiles have [2,3,257,9] shape, artifact rehash PASS, unchanged base state, exact clean D2 provenance, and clean error scans. Profiles remain unassigned; no targets, sealed mapping, B_test, or Full22 were read and no head was trained.

**Result**: Ten target-free profiles are frozen across batch-index SHA256 c5f5e0284e8e6385e974bfd8f42989c01590697330522dae31eae910ffb2ab28, d991c24f4e84231a877449586a51da192b5d0e70c234cbf53b317b73efa137ee, and 78250ad6a75922004407845ce149bdb9d870bf3b5e288d4a445c6395fa7d046a. Final two profiles await the running scratch checkpoints.
...
**Insight**: A label-independent hash first froze 12 unique objects, then an independent secret-salt rank-parity assignment produced exactly six outside_state0 and six outside_state1 presentations with one episode per object; order-only and constant-index controls are exactly 50 percent.

**Result**: Protocol gate and independent P0 PASS: 35 checks, receipt SHA a54d197. Public manifest leakage scan zero, sealed mapping protected, tests 3 passed. This balances observation presentation only; canonical sides are lower=12 upper=0, all selected objects are revolute, and no physical terminal claim is unlocked.

**Branch**: f781a40193c1ee5ff6b7a421a33345e7d8da4208
