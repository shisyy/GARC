#!/usr/bin/env python3
"""Re-certify the frozen D2-CEA v2 endpoint scalars with OEC evidence."""
...
def main() -> None:
    ...
    certificate = oec_certificate(renderer.model, FROZEN_LOWER, FROZEN_UPPER, renderer.ns_s_raw)
    ...
    prediction["renderer"] = "original-splart-plus-frozen-d2-cea-v2-scalars-plus-oec"
    prediction["training"] = dict(prior["training"])
    prediction["training"]["oec_posthoc_only"] = True
    prediction["oec"] = {
